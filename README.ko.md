...
[Chrome Web Store에서 설치하기](https://chromewebstore.google.com/detail/llm-output-guard/cbakgacfpfmggigkeoflpokiceiklgaf)
...
[Chrome Web Store에서 LLM Output Guard 설치하기](https://chromewebstore.google.com/detail/llm-output-guard/cbakgacfpfmggigkeoflpokiceiklgaf)
...
1. [Chrome Web Store](https://chromewebstore.google.com/detail/llm-output-guard/cbakgacfpfmggigkeoflpokiceiklgaf)에서 확장 설치
2. ChatGPT를 열고 의도적으로 닫히지 않은 Markdown 코드 펜스를 출력하게 요청
3. `Markdown fence issue` 배지 확인
4. 배지를 클릭해 수정 미리보기 패널 확인
5. `Copy fixed Markdown` 버튼 확인
